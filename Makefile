HTTPD_CONTAINER = micro_blog_backend_httpd
PHP_CONTAINER = micro_blog_backend_php
...
setup: check
	...
	docker exec $(HTTPD_CONTAINER) chmod -R 777 /var/www/micro-blog-backend/storage
